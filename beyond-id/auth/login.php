...
ob_start(static function (string $html): string {
    ...
    $html = str_replace(['BEYOND OS 2.3.3 BETA','BEYOND OS 2.3.3'], ['BEYOND OS · BETA BUILD 2.3.3','BEYOND OS 2.3.3'], $html);
