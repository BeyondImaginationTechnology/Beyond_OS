...
<div class="app-shell">
  ...
  <main class="container dashboard">
    <section class="panel"><span class="eyebrow">Ottawa first • Across Canada</span><h1>Find a studio</h1><p class="section-copy">Browse <?= count($studios) ?> verified studio listings with Ottawa-area shops prioritized and Canadian cities searchable by name, province, service, or location.</p>
