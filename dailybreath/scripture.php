...
<nav class="bottom"><a href="index.php?faith=<?= e($tradition) ?>">Home</a><a href="<?= e($reflectionHref) ?>"><?= e($reflectionLabel) ?></a><a class="active" href="scripture.php?tradition=<?= e($tradition) ?>"><?= e($traditionLabel) ?></a><a href="academy.php">Academy</a><a href="practices.php?section=breathing">Breathe</a></nav>
<script>
