...
BEYOND_CORE_DEPENDENCIES = sdl2 sdl2_image sdl2_ttf host-pkgconf

define BEYOND_CORE_BUILD_CMDS
	$(TARGET_CC) $(TARGET_CFLAGS) -std=c11 -Wall -Wextra -Werror \
		$$($(PKG_CONFIG_HOST_BINARY) --cflags sdl2 SDL2_image SDL2_ttf) \
		$(@D)/core.c -o $(@D)/beyond-core $(TARGET_LDFLAGS) \
		$$($(PKG_CONFIG_HOST_BINARY) --libs sdl2 SDL2_image SDL2_ttf) -lm
	$(TARGET_CC) $(TARGET_CFLAGS) -std=c11 -Wall -Wextra -Werror \
