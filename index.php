...
.currency-picker{position:relative;display:flex;align-items:center;min-width:84px;height:43px;border:1px solid rgba(255,255,255,.2);border-radius:999px;background:rgba(255,255,255,.055);overflow:hidden}.currency-picker:focus-within{outline:2px solid #a99cff;outline-offset:2px}.currency-picker>span[aria-hidden="true"]{display:none}.currency-picker>span.visually-hidden{position:absolute!important}.currency-picker select{position:relative;width:100%;height:100%;padding:0 25px 0 12px;border:0;outline:0;color:#fff;background:transparent;font:900 11px/1 inherit;cursor:pointer;appearance:none}.currency-picker:after{content:"⌄";position:absolute;right:10px;top:11px;color:#aeb4ca;font-size:12px;pointer-events:none}.currency-picker option{color:#111;background:#fff}html[data-theme="light"] .currency-picker{border-color:rgba(23,26,46,.2);background:rgba(255,255,255,.62)}html[data-theme="light"] .currency-picker select{color:#171a2e}@media(max-width:560px){.currency-picker{min-width:78px;height:40px}.currency-picker select{padding-left:10px;padding-right:20px;font-size:10px}.currency-picker:after{right:7px}}
...
<section class="jaguar-banner wrap" id="jaguar" aria-labelledby="jaguar-title">
    ...
    <a class="ghost" href="/ai/">Explore Jaguar →</a>
</section>
...
<nav class="home-shortcuts wrap" aria-label="Beyond Imagination Technology quick destinations">
