...
<title>Jaguar v0.3 | Beyond AI</title><meta name="description" content="Jaguar v0.3 is Beyond Imagination Technology’s AI suite for Core, Draw, and Video.">
<style>
...
(() => {
    ...
    function updateModeStatus() {
        const text = copy[language];
        modeStatus.textContent = modeSelect.value === 'draw'
            ? text.drawStatus
