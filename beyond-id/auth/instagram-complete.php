    ...
    if (!verify_csrf_token($_POST['csrf'] ?? null)) {
        ...
        elseif (empty($_POST['accept_terms'])) $error = 'Accept the Terms and Privacy Policy to create a Beyond ID.';
            ...
            try {
                ...
                create_notification($pdo, $userId, 'Welcome to Beyond ID', 'Your Beyond ID is connected to Instagram.', '/beyond-id/dashboard/profile.php', 'welcome');
