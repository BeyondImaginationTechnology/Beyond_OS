...
$date=(new DateTimeImmutable('today',new DateTimeZone('America/Vancouver')))->format('Y-m-d');$dbPath=beyond_private_file('db/daily-studio.sqlite','daily-studio.sqlite');$fact=null;
