/* BIT OS Cyber: native defensive-workstation desktop. */
...
static bool save_note(void)
{
    ...
    dirty = false;
    snprintf(status, sizeof status, "Saved to Documents/Cyber Note.txt");
    return true;
}
...
int main(int argc, char **argv)
{
    ...
    if (!join_path(note_path, sizeof note_path, home, "Documents/Cyber Note.txt") ||
