...
{
    return [
        'core' => ['label' => 'Explain', 'description' => 'Fast utility answers, lookups, and concise built-in guidance without GPU inference.', 'status' => 'live', 'plan' => 'free', 'credits' => 0, 'instruction' => 'Answer with concise built-in guidance only; do not invoke deep model reasoning.'],
