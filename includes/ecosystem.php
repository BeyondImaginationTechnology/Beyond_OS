...
function beyond_app_bootstrap(string $appName): array {
    ...
    $wallet = beyond_wallet();
    header('X-Beyond-OS-Version: 2.3.3');
...
</style><nav id="beyond-os-shell" aria-label="Beyond OS navigation"><div class="bos-row"><a class="bos-home" href="' . $home . '" aria-label="Beyond OS 2.3.3" title="Beyond OS 2.3.3">' . $homeIcon . '<span class="bos-home-label">BEYOND OS 2.3.3</span></a>' . $appIdentity . '<div class="bos-actions">' . $appStoreAction . $navTools . $accountActions . '</div></div></nav>';
}
