...
- Replaces the generator’s `B= / BITS` badge with the official Beyond French logo.
- Preloads the logo before PNG and video export so downloaded media is consistently branded.
- Adds an iOS beta landing page with a branded app preview and signup path.
- Adds App Store icon sources, 6.7-inch and 6.9-inch screenshot previews, marketing artwork, and suggested listing copy.
