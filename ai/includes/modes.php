...
function jaguar_mode_catalog(): array
{
    return [
        ...
        'build' => ['label' => 'Build', 'description' => 'Turn an approved idea into a scoped product plan, code tasks, and launch checklist.', 'runtime' => 'code', 'status' => 'planned', 'plan' => 'builder', 'credits' => 0, 'instruction' => 'Break a product goal into a safe, testable implementation plan before taking action.'],
