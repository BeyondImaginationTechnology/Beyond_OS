...
<main class="bos-main app-store-main">
  ...
  <section class="bos-section" id="explore">
    ...
    <div class="bos-grid">
      ...
      <?=bos_app_card('Beyond AI','Jaguar AI for explaining ideas, shaping plans, and building across the Beyond ecosystem.','ai/','AI','Open desktop app','@blank')?>
