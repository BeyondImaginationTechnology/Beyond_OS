...
function jaguar_mode_catalog(): array
{
    return [
        ...
        'cub' => ['label' => 'Cub', 'description' => 'Instant, lightweight Jaguar help without GPU use.', 'status' => 'live', 'plan' => 'free', 'credits' => 0, 'instruction' => 'Offer short, safe, deterministic help only.'],
