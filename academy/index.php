...
<main class="bos-main academy-main">
  <section class="bos-hero academy-certificate-lead" id="certificates">
    <span class="bos-kicker">Beyond Certificate</span>
    <h1>Three pathways.<br>Real proof of learning.</h1>
    <p>Begin with Essential Math, Web Development Foundations, or Personal Finance Foundations. Every pathway includes tracked lessons, a scored assessment, a Beyond ID badge, and a public verification record.</p>
    <div class="bos-actions"><a class="bos-btn secondary" href="<?=e(beyond_url('academy/verify.php'))?>">Verify a certificate</a></div>
    <div class="bos-grid academy-pathway-grid">
    ...
    <?=bos_app_card('Personal Finance Foundations','Budgeting, saving, credit, interest and fraud awareness.','academy/pathway.php?course=personal-finance-foundations','$','Start pathway','@atom')?>
    </div>
  </section>
  ...
  <section class="bos-hero academy-hero academy-closing"><span class="bos-kicker">Beyond Academy</span><h1>Learn it.<br>Prove it.</h1><p>Build real skills, complete guided lessons, pass assessments and earn a verifiable Beyond-issued certificate.</p><div class="bos-actions"><a class="bos-btn" href="#certificates">Choose a pathway</a><a class="bos-btn secondary" href="<?=e(beyond_url('academy/verify.php'))?>">Verify a certificate</a></div></section>
</main>
<style>.academy-main{width:min(1240px,calc(100% - 28px))}.academy-certificate-lead,.academy-hero{background:radial-gradient(circle at 85% 12%,color-mix(in srgb,var(--accent) 24%,transparent),transparent 28%),linear-gradient(135deg,var(--surface-deep),var(--surface-strong) 58%,color-mix(in srgb,var(--primary) 32%,var(--surface-deep)))}.academy-certificate-lead>p{max-width:780px}.academy-pathway-grid{margin-top:30px}.academy-pathway-grid .bos-card{background:color-mix(in srgb,var(--surface-strong) 90%,transparent);backdrop-filter:blur(16px)}.academy-closing{margin-top:28px}.academy-main .bos-card-icon{width:62px;height:62px}</style>
<?php bos_page_end(); ?>
