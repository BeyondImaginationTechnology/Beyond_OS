...
$apps=[
 'dailybreath'=>['name'=>'DailyBreath','icon'=>'🌿','summary'=>'Faith, recovery, and weekly publishing','tools'=>[['content','Content corrections','Emergency edits to daily content','dailybreath-content.php'],['breath','Scheduled generator','Generate dated verse content','breath-generator.php'],['jaguar','Jaguar training','Review DailyBreath comprehension examples','jaguar-training.php'],['recovery-newsletter','Recovery newsletter','Package the weekly shareable issue','recovery-newsletter.php']]],
