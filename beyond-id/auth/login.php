...
ob_start(static function (string $html) use (&$instagramLoginHtml): string {
    ...
    $html = str_replace(['BEYOND OS 2.4 BETA','BEYOND OS 2.4'], ['BEYOND OS · BETA BUILD 2.4','BEYOND OS 2.4'], $html);
