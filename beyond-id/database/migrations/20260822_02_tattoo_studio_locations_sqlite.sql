ALTER TABLE tattoo_studios ADD COLUMN latitude REAL NULL;
ALTER TABLE tattoo_studios ADD COLUMN longitude REAL NULL;
ALTER TABLE tattoo_studios ADD COLUMN website_url TEXT NULL;
ALTER TABLE tattoo_studios ADD COLUMN booking_url TEXT NULL;
ALTER TABLE tattoo_studios ADD COLUMN verification_status TEXT NOT NULL DEFAULT 'unverified';
ALTER TABLE tattoo_studios ADD COLUMN verified_at TEXT NULL;
...
UPDATE tattoo_studios SET
  ...
  website_url=instagram_url,booking_url=instagram_url,verification_status='verified',verified_at='2026-08-22T00:00:00Z'
