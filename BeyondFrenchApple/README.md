...
Native SwiftUI beta for Beyond French 2.0.0.

## Free guest access

- Generator-published Lesson of the Day
- Searchable multilingual dictionary
- Greetings Module, Lesson 1
- Daily phrase practice

A Beyond ID unlocks the remaining Academy lessons, tests, saved progress, and rewards.
