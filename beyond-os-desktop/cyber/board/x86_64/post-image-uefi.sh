...
cp "$BINARIES_DIR/rootfs.iso9660" "$BINARIES_DIR/bitCyberos.iso"
sha256sum "$BINARIES_DIR/bit-os-cyber-1.0-installer.img" "$BINARIES_DIR/bitCyberos.iso" "$root_image" > "$BINARIES_DIR/SHA256SUMS"
