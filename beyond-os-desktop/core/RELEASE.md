# Beyond Imagination OS Core Edition 1.0 release gates
...
Do not label, market, or support an ISO, USB image, or Windows installer profile as stable Beyond Imagination OS Core 1.0 until the applicable gates pass. Public test-candidate downloads must remain clearly labelled and accompanied by their SHA-256 manifest.
