    ...
    if (!Auth::verifyCsrf($_POST['csrf'] ?? null)) {
        ...
        try {
            if ($action === 'create') {
                ...
                if (mb_strlen($instruction) > 4000 || mb_strlen($input) > 8000 || mb_strlen($output) > 12000) throw new RuntimeException('This example is too long.');
