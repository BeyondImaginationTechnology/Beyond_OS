...
if(!in_array($library,['daily-breath','beyond-french'],true)||$text===''||strlen($text)>10000||!in_array($locale,['en-US','fr-FR','fr-CA','es-ES','en-JM','ht-HT'],true)) failx(422,'Invalid MP3 export request.');
