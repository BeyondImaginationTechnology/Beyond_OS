...
$view=file_get_contents(__DIR__.'/generators/history-fact-generator-view.html');if($view===false){http_response_code(500);exit('Beyond Ancient fact generator view is unavailable.');}
